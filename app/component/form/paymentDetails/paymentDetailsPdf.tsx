  ...
  return (
    <View>
      ...
      >
        ...
        >
          ...
          <View style={{ flexDirection: "column", gap: 5 }}>
            <View style={pdfUtils.flexRowItemCenter}>
              <Text style={pdfTypography.paymentTitle}>Naziv banke</Text>
              <Text
                style={{
                  flex: 1,
            ...
            <View style={pdfUtils.flexRowItemCenter}>
              <Text style={pdfTypography.paymentTitle}>Vlasnik računa</Text>
              <Text
                style={{
                  flex: 1,
                  ...pdfTypography.itemDescription,
        ...
        >
          <Text style={{ ...pdfTypography.title, paddingBottom: 12, display: "none", }}>
            Payable in
          </Text>
          {currencyDetails && (
            <View style={{ ...pdfUtils.flexRowItemCenter, gap: 8, display: "none", }}>
              <Image
                src={countryImageUrl}
                style={{
                  width: 30,
